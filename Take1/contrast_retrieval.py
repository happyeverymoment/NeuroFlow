...
from nets.DreamDiffusion import DreamDiffusion_encoder 
...
from nets.BrainDreamerCLP import BrainDreamerEEGEncoder ,LSTMEncoder,CNNEncoder,Brain2ImageEncoder,SemanticRegionAwareTransformer
from nets.Cogcap import Cogcap
...
class MetaEEG(nn.Module):
    ...
    def forward(self, x, subject_id=0):
        ...
        clip_out = self.clip_head(x).squeeze(-1)
        return clip_out
...
def main():
    ...
    # parser.add_argument('--encoder_type', type=str, default='DreamDiffusion_encoder', help='EEG encoder model type, you can choose from these options: Projector, EEGConformer_Encoder, MetaEEG, EEGNetv4_Encoder, ShallowFBCSPNet_Encoder, NICE, ATCNet_Encoder, EEGITNet_Encoder')
    ...
    # parser.add_argument('--save_name', type=str, default='ATM_E_clip_wGNN', help='EEG encoder model type, you can choose from these options: Projector, EEGConformer_Encoder, MetaEEG, EEGNetv4_Encoder, ShallowFBCSPNet_Encoder, NICE, ATCNet_Encoder, EEGITNet_Encoder')
    ...
    parser.add_argument('--save_name', type=str, default='SemanticRegionAwareTransformer_clip', help='EEG encoder model type, you can choose from these options: Projector, EEGConformer_Encoder, MetaEEG, EEGNetv4_Encoder, ShallowFBCSPNet_Encoder, NICE, ATCNet_Encoder, EEGITNet_Encoder')
    ...
    for sub in subjects:
        ...
        if args.encoder_type == 'NICE' or args.encoder_type == 'EEGNetv4_Encoder' \
            or args.encoder_type == 'ShallowFBCSPNet_Encoder'  \
                or args.encoder_type == 'ATCNet_Encoder' or args.encoder_type == 'EEGConformer_Encoder'\
                    or args.encoder_type == 'EEGITNet_Encoder' or args.encoder_type == 'Cogcap' or args.encoder_type == 'SemanticRegionAwareTransformer' :
        ...
        elif args.encoder_type == 'DreamDiffusion_encoder' or args.encoder_type == 'BrainDreamerEEGEncoder' \
                or args.encoder_type == 'LSTMEncoder' or args.encoder_type == 'CNNEncoder':
            model = globals()[args.encoder_type]()
        else:
            model = globals()[args.encoder_type]((63, 250))
        model.to(device)
