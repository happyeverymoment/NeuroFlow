...
class EEGDataset():
    ...
    def __init__(self, data_path, exclude_subject=None, subjects=None, train=True, time_window=[0, 1.0], classes = None, pictures = None, val_size=None):
        ...
        if self.classes is None and self.pictures is None:
            ...
            if os.path.exists(features_filename) :
                ...
                self.text_features = saved_features['text_features']#shape =torch.Size([1654, 1024])
    ...
    def load_data(self):
        ...
        for dir in dirnames:
            ...
            new_description = f"An image of  {description}, photorealistic, realistic lighting, high detail, sharp focus, natural environment"
